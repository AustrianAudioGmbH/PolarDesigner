...
PolarDesignerAudioProcessor::PolarDesignerAudioProcessor() :
    ...
    params(*this, nullptr, "AAPolarDesigner",
           {
               std::make_unique<AudioParameterFloat> ("xOverF1", "Crossover F1", NormalisableRange<float>(0.0f, 1.0f, 0.0001f),
                                                      ...
                                                      nullptr),
               std::make_unique<AudioParameterFloat> ("xOverF2", "Crossover F2", NormalisableRange<float>(0.0f, 1.0f, 0.0001f),
                                                      ...
                                                      nullptr),
               std::make_unique<AudioParameterFloat> ("xOverF3", "Crossover F3", NormalisableRange<float>(0.0f, 1.0f, 0.0001f),
                                                      ...
                                                      nullptr),
               std::make_unique<AudioParameterFloat> ("xOverF4", "Crossover F4", NormalisableRange<float>(0.0f, 1.0f, 0.0001f),
                                                      ...
                                                      nullptr),
               std::make_unique<AudioParameterFloat> ("alpha1", "Directivity Low", NormalisableRange<float>(-0.5f, 1.0f, 0.01f),
                                                      0.0f, "", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 2); }, nullptr),
               std::make_unique<AudioParameterFloat> ("alpha2", "Directivity LowMid", NormalisableRange<float>(-0.5f, 1.0f, 0.01f),
                                                      0.0f, "", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 2); }, nullptr),
               std::make_unique<AudioParameterFloat> ("alpha3", "Directivity Mid", NormalisableRange<float>(-0.5f, 1.0f, 0.01f),
                                                      0.0f, "", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 2); }, nullptr),
               std::make_unique<AudioParameterFloat> ("alpha4", "Directivity HighMid", NormalisableRange<float>(-0.5f, 1.0f, 0.01f),
                                                      0.0f, "", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 2); }, nullptr),
               std::make_unique<AudioParameterFloat> ("alpha5", "Directivity High", NormalisableRange<float>(-0.5f, 1.0f, 0.01f),
                                                      0.0f, "", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 2); }, nullptr),
               std::make_unique<AudioParameterBool>  ("solo1", "Solo Low", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("solo2", "Solo LowMid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("solo3", "Solo Mid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("solo4", "Solo HighMid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("solo5", "Solo High", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("mute1", "Mute Low", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("mute2", "Mute LowMid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("mute3", "Mute Mid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("mute4", "Mute HighMid", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterBool>  ("mute5", "Mute High", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr),
               std::make_unique<AudioParameterFloat> ("gain1", "Gain Low", NormalisableRange<float>(-24.0f, 18.0f, 0.1f),
                                                      0.0f, "dB", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 1); }, nullptr),
               std::make_unique<AudioParameterFloat> ("gain2", "Gain LowMid", NormalisableRange<float>(-24.0f, 18.0f, 0.1f),
                                                      0.0f, "dB", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 1); }, nullptr),
               std::make_unique<AudioParameterFloat> ("gain3", "Gain Mid", NormalisableRange<float>(-24.0f, 18.0f, 0.1f),
                                                      0.0f, "dB", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 1); }, nullptr),
               std::make_unique<AudioParameterFloat> ("gain4", "Gain High", NormalisableRange<float>(-24.0f, 18.0f, 0.1f),
                                                      0.0f, "dB", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 1); }, nullptr),
               std::make_unique<AudioParameterFloat> ("gain5", "Gain HighMid", NormalisableRange<float>(-24.0f, 18.0f, 0.1f),
                                                      0.0f, "dB", AudioProcessorParameter::genericParameter,
                                                      [](float value, int maximumStringLength) { return String(value, 1); }, nullptr),
               ...
               std::make_unique<AudioParameterBool>  ("zeroDelayMode", "Zero Delay Mode", false, "",
                                                      [](bool value, int maximumStringLength) {return (value) ? "on" : "off";}, nullptr)
           }),
