        ...
        termStage(PolarDesignerAudioProcessorEditor::terminatorStage::DISABLED)
{
    ...
    tbLogoAA.setTooltip(String(BUILD_TAG) + String("-") + String(BUILD_COMMIT_HASH) + String::formatted(" (%p)", this) );
    Logger::writeToLog("PolarDesigner3 Build:" + String(BUILD_TAG) + String("-") + String(BUILD_COMMIT_HASH));
